...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.koji4104.mylive_libraly.MyLivePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin mylive_libraly, com.koji4104.mylive_libraly.MyLivePlugin", e);
    }
    try {
